...
```{r grafico_cant_animales, echo=FALSE}
...
```{r grafico_comparacion_verdad_cruda, echo=FALSE}
ggplot(comparacion,
       aes(x = tasa_real,
           y = tasa_cruda)) +
  geom_point() +
...
```{r grafico_comparacion_EB_verdadera, echo=FALSE}
ggplot(comparacion,
       aes(x = tasa_real,
           y = tasa_EB)) +
...
```{r curva_Kaplan_Meier, echo=FALSE}
...
```{r grafico_comparacion_perro_gato, fig.align='center', echo=FALSE}
km_animal <- survfit(
...
plot(
    ...
    xlab = "Días",
    ylab = "S(t)",
    main = "Kaplan-Meier según tipo de animal"
)
...
```{r grafico_comparacion_sexo, fig.align='center', echo=FALSE}
km_sexo <- survfit(
    surv_obj ~ sexo,
    data = refugio
)
...
```{r grafico_comparacion_esterilizados, fig.align='center', echo=FALSE}
km_est <- survfit(
    surv_obj ~ sterilized,
    data = refugio
)
...
plot(
    ...
    xlab = "Días",
    ylab = "S(t)",
    main = "Kaplan-Meier según esterilización"
)
...
```{r grafico_comparacion_edad, echo=FALSE, results="hide"}
