...
summary(model)
```
El hecho de que `Adopción` sea la variable de referencia significa que para cada fila, estamos analizando la probabilidad de que el resultado sea la categoría de esa fila contra la probabilidad de que el resultado sea `Àdopción`, normalizado para que todas las probabilidades sumen 1.
