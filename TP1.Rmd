...
```
La Figura 3 compara las estimaciones obtenidas mediante el método Empirical Bayes con la tasa verdadera de adopción calculada utilizando el conjunto completo de datos. La línea roja representa la recta identidad (y=x), correspondiente al caso ideal en el que la estimación coincide exactamente con la tasa verdadera. Los estimadores bayesianos son los puntos negros, y para comparar con el gráfico anterios, se mantuvieron los estimadores crudos en azul.
